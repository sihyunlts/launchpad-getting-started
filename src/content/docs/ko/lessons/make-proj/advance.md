...
:::note[관련 정보]
런치패드 프로 MK1을 사용하고, 성능 최적화 커스텀 펌웨어를 설치했다면 더 편리합니다. 이 커스텀 펌웨어는 4개의 커스텀 팔레트를 내장할 수 있어 `Setup`에서 한 번에 전환할 수 있습니다. 또한 런치패드 펌웨어 도우미에서도 펌웨어를 다시 플래시하지 않고 한 번에 업로드할 수 있습니다.
